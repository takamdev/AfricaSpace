...
ajoutPanier.forEach((Element) => {
   ...
   Element.addEventListener("click", () => {
      ...
      let nomOeuvres =
         Element.parentNode.parentNode.parentNode.children[1].textContent;

      let prixOeuvre =
         Element.parentNode.parentNode.parentNode.children[2].querySelector(
            "span"
         ).textContent;
      let prixOeuvrePretPourCalcul =
         Element.parentNode.parentNode.parentNode.children[2]
            .querySelector("span")
      ...
      let total =
         parseInt(containPanier.children[0].querySelector("span").textContent) +
         prixOeuvrePretPourCalcul;
      ...
      commandes.forEach((commande) => {
         commande.querySelector("img").addEventListener("click", () => {
            ...
            let total =
               parseInt(
                  containPanier.children[0].querySelector("span").textContent
               ) - prixcal;
            containPanier.children[0].querySelector(
               "span"
            ).textContent = `${total}F`;
            commande.remove();
         });
